...
from margarine import rbac_utils as utils
...
class RBACUtilsTest(base.TestCase):
    ...
    @mock.patch('margarine.rbac_utils.CONF')
    @mock.patch('margarine.rbac_utils.urllib3')
    ...
    @mock.patch('margarine.rbac_utils.CONF')
    @mock.patch('margarine.rbac_utils.RbacUtils.get_roles')
    @mock.patch('margarine.rbac_utils.urllib3')
